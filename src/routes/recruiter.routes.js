...
import {postRecruitment, getAllPostedRecruitment} from "../controllers/recruiterPostRecruitment.controller.js"
...
router.route("/getAllPostedRecruitments").get(verifyUser, verifyRecruiter, getAllPostedRecruitment);
